...
% the simulation
zs = simulate_system(ym0, xp0, r, Ap, Bp, hp, Ac, Bc, kp, time, theta00, theta10, theta20);
...
function [zs] = simulate_system(ym0, xp0, r, Ap, Bp, hp, Ac, Bc, kp, time, theta00, theta10, theta20)
    ...
    z0 = [ym0; xp0; xc10; xc20; theta00; theta10; theta20];
    % preallocate space to keep the results
    zs = zeros(length(time), 8);
...
function dzdt = syst(t, z, r, Ap, Bp, Ac, Bc, hp, kp)
    ...
    dzdt = [dymdt; dxpdt; dxc1dt; dxc2dt; dtheta0dt; dtheta1dt; dtheta2dt];
end